...
const int BNO_BOOT_PIN = 34;
const int BNO_RESET_PIN = 35;
...
const int COLOR2_S0 = 35;
const int COLOR2_S1 = 36;
const int COLOR2_S2 = 37;
const int COLOR2_S3 = 38;
const int COLOR2_OUT = 39;
